...
EMQ X企业版集群可作为物联网接入服务(IoT Hub)，部署在青云、AWS、阿里等公有云或企业私有云平台。
...
部署架构推荐在LB终结SSL连接。设备与LB之间SSL安全连接，LB与EMQ X之间TCP连接。这种部署模式下EMQ X单集群可支持100万设备连接。
...
+---------------+-----------------+----------------------------------------------------+
| `UCloud`_     | 未测试          | https://ucloud.cn/site/product/ulb.html            |
+---------------+-----------------+----------------------------------------------------+
| `QCloud`_     | 未测试          | https://www.qcloud.com/product/clb                 |
+---------------+-----------------+----------------------------------------------------+
