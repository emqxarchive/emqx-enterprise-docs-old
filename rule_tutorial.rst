...
0. 启动 InfluxDB，请确保启用了相应的 Listener（我们假设您已经成功安装了 InfluxDB 环境）
...
4. 填写资源配置:
   ...
   .. image:: ./_static/images/influxdb-resource-2@2x.png
...
5. 返回响应动作界面，选择刚刚创建的 InfluxDB 资源，填写其余配置后点击 “Confirm” 按钮。

6. 最后返回规则创建界面，点击页面底部的 “Create” 按钮，完成规则创建。 
...
7. 规则已经创建完成，现在发一条消息:
  ...
  .. image:: ./_static/images/influxdb-rulelist-1@2x.png
